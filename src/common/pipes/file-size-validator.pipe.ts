 ...
 * @publicApi
 */
export class FileSizeValidatorPipe extends FileValidator<FileSizeValidatorOptions, IFile> {
	...
	isValid(file?: IFile): boolean {
		...
		return !!file && 'mimetype' in file && +file.size < this.validationOptions.fileSize;
	}
}
