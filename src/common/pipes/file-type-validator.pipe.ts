 ...
 * @publicApi
 */
export class FileTypeValidatorPipe extends FileValidator<FileTypeValidatorOptions, IFile> {
	...
	isValid(file?: IFile): boolean {
		...
		return !!file && 'mimetype' in file && this.validationOptions.fileType.includes(file.mimetype);
	}
}
