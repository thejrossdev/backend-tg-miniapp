 ...
 */
export class UserExceptionDeleteFail extends DomainException {
	/**
	 * Error code for  exception.
	 */
	public readonly code = UserErrorCode.USER_DELETE_INTERNAL;
	...
	/**
	 * Creates an instance of UserExceptionDeleteFail.
	 *
	...
	constructor(
		...
		super(i18n.t('exceptions.users.USER_DELETE_INTERNAL', { args: { data } }));
	}
}
